...
namespace AvatarsInGraveDanger
{
     ...
     /// </remarks>
     public class AdvancedSlingerEnemy : Enemy
     {
          #region Fields
          ...
          /// </summary>
          public AdvancedSlingerEnemy(Vector3 position, Wave wave)
          ...
          public override void Update(GameTime gameTime)
          {
               if (ProjectileList != null)
               {
                    ...
                    {
                         // And update them!
                         projectile.AdvancedUpdate(gameTime);
                    }
               }
               ...
               if (elapsedTimeSinceThrew >= timeBetweenThrows)
               {
                    if (Math.Abs(this.Wave.CurrentPlayer.Position.Z - this.Position.Z) > 2.0f)
                    {
                         ...
                         timeBetweenThrows = 1.0f + (float)(random.NextDouble() * 3f);
          ...
          public void ThrowProjectile()
          {
               ...
               this.targetPosition = new Vector3(this.Wave.CurrentPlayer.Position.X, 2.0f, this.Wave.CurrentPlayer.Position.Z);
               projectile.TrueVelocity = this.targetPosition - projectile.Position;
