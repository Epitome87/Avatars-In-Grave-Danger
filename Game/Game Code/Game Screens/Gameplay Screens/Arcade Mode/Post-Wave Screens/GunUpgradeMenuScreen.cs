...
namespace AvatarsInGraveDanger
{
     ...
     /// </remarks>
     public class UziUpgradeMenuScreen : MenuScreen
     {
          #region Fields
          ...
          /// <summary>
          /// MenuEntry for purchasing more Ammo.
          /// </summary>
          MenuEntry ammoMenuEntry = new MenuEntry("Ammo", "Cost: $500");
          ...
          /// Constructor.
          /// </summary>
          public UziUpgradeMenuScreen(ArcadeLevel arcadeLevel, WaveManager _waveManager, int gunIndex)
               : base("Uzi Upgrades")
          {
               ...
               ammoMenuEntry.Selected += AmmoMenuEntrySelected;
               ...
               // Add the purchase ammo menu entry.
               MenuEntries.Add(ammoMenuEntry);
               ...
               this.theArcadeLevel.CurrentPlayer.Gun = this.theArcadeLevel.CurrentPlayer.PlayersGuns[gunIndex];

               clipSizeUpgradeFactor = 6;                        // 1/3rd initial clip size.
               rateOfFireUpgradeFactor = 7.5f / 5.0f;            // 20% of initial value.
               reloadSpeedUpgradeFactor = 250.0f;
               reloadAreaUpgradeFactor = 5.0f;
          }
          ...
          private int ammoCost = 500;
          private int ammoPurchaseAmount = 64;
          ...
          private void AmmoMenuEntrySelected(object sender, PlayerIndexEventArgs e)
          {
               if (this.theArcadeLevel.CurrentPlayer.Gun.TotalAmmo > this.theArcadeLevel.CurrentPlayer.Gun.MaximumAmmo)
               {
                    return;
               }

               if (this.theArcadeLevel.CurrentPlayer.Money >= ammoCost)
               {
                    this.theArcadeLevel.CurrentPlayer.Money -= ammoCost;

                    this.theArcadeLevel.CurrentPlayer.Gun.TotalAmmo += ammoPurchaseAmount;
          ...
          private void RateOfFireUpgradeMenuEntrySelected(object sender, PlayerIndexEventArgs e)
          {
               ...
               rateOfFireUpgradeCost = (this.theArcadeLevel.CurrentPlayer.Gun.RateOfFireLevel + 1) * 0;// basePrice;
          ...
          private void UpdateMenuDescriptions()
          {
               ...
               if (this.theArcadeLevel.CurrentPlayer.Gun.TotalAmmo >= this.theArcadeLevel.CurrentPlayer.Gun.MaximumAmmo)
               {
                    ammoMenuEntry.Description = "Max Ammo!\n\nCurrent Ammo:\n" + (this.theArcadeLevel.CurrentPlayer.Gun.TotalAmmo).ToString();
               }

               else
               {
                    ammoMenuEntry.Description = "Price: $" + ammoCost.ToString("N0") +
                         "\n\nDescription:\nIncrease Ammo by 64.\n\nCurrent Ammo:\n" + (this.theArcadeLevel.CurrentPlayer.Gun.TotalAmmo).ToString();
               }
              ...
              Color goldBarColorWithTransition = Color.Gold * (TransitionAlpha / 255f);
               ...
               for (int i = 0; i < 5; i++)
               {
                   ...
                   GraphicsHelper.DrawBorderFromRectangle(blankTexture.Texture2D, new Rectangle(startingX + (barSize * i), startingY, barSize, barSize), 2, Color.Black * (TransitionAlpha / 255f));
                    ...
                    if (this.theArcadeLevel.CurrentPlayer.Gun.RateOfFireLevel > i)
                    {
