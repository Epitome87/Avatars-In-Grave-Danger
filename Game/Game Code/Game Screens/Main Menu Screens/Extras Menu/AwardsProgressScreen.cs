...
namespace AvatarsInGraveDanger
{
     ...
     /// </remarks>
     public class AwardsProgressScreen : MenuScreen
     {
          #region Fields
          ...
          private uint totalZombiesKilled;
          private uint totalCloseCalls;
          ...
          /// Constructor.
          /// </summary>
          public AwardsProgressScreen()
               : base("Award5 Progress")
          {
               totalZombiesKilled = AvatarZombieGame.AwardData.TotalKills;
               totalCloseCalls = AvatarZombieGame.AwardData.TotalCloseCalls;
