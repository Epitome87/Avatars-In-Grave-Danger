...
namespace AvatarsInGraveDanger
{
     ...
     public class MessageBoxScreen : GameScreen
     {
          ...
          public override void LoadContent()
          {
               ...
               blankTexture = ResourceManager.LoadTexture(@"Textures\Blank Textures\Blank");// (@"Textures\Blank Textures\Border_Wide_White");
               gradientTexture = ResourceManager.LoadTexture(@"Textures\Gradients\Gradient_BlackToWhite1");// (@"Textures\Blank Textures\Blank_Rounded_Wide");
          ...
          public override void Draw(GameTime gameTime)
          {
               ...
               Color acolor = Color.Black * (60f / 255f);
