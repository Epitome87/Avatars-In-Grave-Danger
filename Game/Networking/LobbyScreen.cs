...
using AvatarsInGraveDanger.Networking;
    ...
    class LobbyScreen : GameScreen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (!IsExiting)
            {
                if (networkSession.SessionState == NetworkSessionState.Playing)
                {
                    ...
                    LoadingScreen.Load(true, null,
                                       new MainMenuScreen());// GameplayScreen(networkSession));
                }
        ...
        void HandleMenuCancel(LocalNetworkGamer gamer)
        {
            ...
            else
            {
                ...
                NetworkSessionComponent.LeaveSession(ScreenManager.GetInstance, playerIndex);
            }
        }
