...
namespace PixelEngine.AchievementSystem
{
     ...
     public class Achievement
     {
          ...
          private GameResourceTexture2D picture = null;
          ...
          /// 
          /// If the Achievement is a Secret Achievement and has yet to be Unlocked,
          /// the Description will be "Unlock Award To See Description."
          /// </summary>
          ...
          /// </summary>
          public GameResourceTexture2D Picture
          {
               get { return picture; }
               set { picture = value; }
          }
          ...
          /// </param>
          public Achievement(string name, string achievementDescription, int target, CheckProgressDelegate progressDelegate)
               : this(name, achievementDescription)
          {
               targetValue = target;
          ...
          public Achievement(string name, string achievementDescription, GameResourceTexture2D texture)
          {
               title = name;
          ...
          public Achievement(string name, string achievementDescription, int points, int target, CheckProgressDelegate progressDelegate)
               : this(name, achievementDescription)
          {
               PointValue = points;
               targetValue = target;
          ...
          /// <param name="achievementDescription">The Description of the Achievement</param>
          /// <param name="points">The Point Value of the Achievement.</param>
          /// <param name="secret">Whether or not this is a Secret Achievement.</param>
          /// <param name="target">The Target Value for the Achievement (when it is Unlocked).</param>
          /// <param name="progressDelegate">The CheckProgressDelegate method that will run the logic
          /// for checking when the Achievement is to be Unlocked - usually once "Target" value is reached.</param>
          public Achievement(string name, string achievementDescription, int points, bool secret, int target, CheckProgressDelegate progressDelegate)
               : this(name, achievementDescription)
          {
               PointValue = points;
               isSecret = secret;
