...
namespace PixelEngine.AchievementSystem
{
     ...
     public class AchievementManager : DrawableGameComponent
     {
          ...
          private static GameResourceTexture2D defaultPicture;
          ...
          /// <summary>
          /// Returns the total Points Value of all the Acheivements
          /// being handled by this Achievement Manager.
          /// 
          /// This would equate to the total GamerScore possible to obtain
          /// in terms of Achievements.
          /// </summary>
          public static int TotalAchievementValue
          {
               get
               {
                    int totalValue = 0;
                    ...
                    {
                         totalValue += achievement.PointValue;
                    }
          ...
          /// <summary>
          /// Returns the total Points Value of all the *UNLOCKED* Achievements
          /// being handled by this Achievement Manager.
          /// 
          /// This would equate to a GamerScore in terms of Achievements.
          /// </summary>
          public static int EarnedAchievementValue
          {
               get
               {
                    int totalValue = 0;
          ...
          protected override void LoadContent()
          {
               ...
               defaultPicture = ResourceManagement.ResourceManager.LoadTexture(@"Achievements\Award"); //content.Load<Texture2D>(@"Achievements\Award");
          ...
          /// 
          /// Performs update logic such as deciding when to check
          /// each Achievement's IsUnlocked status and progress, queueing
          /// Achievements up, and Popping them up when Unlocked.
          /// </summary>
