...
namespace PixelEngine.Audio
{
     ...
     public class AudioManager : GameComponent
     {
          ...
          /// </summary>
          private static AudioEngine audioEngine;                  // Remove static
          ...
          public static Cue GetCue(string cueName)
          {
               ...
               */
               ...
               if (String.IsNullOrEmpty(cueName) ||
                   (audioManager == null) || (audioEngine == null) ||
                   (audioManager.soundBank == null) || (audioManager.waveBank == null))
               {
                    return null;
               }
          ...
          public static void PlayCue(string cueName)
          {
               ...
               */
               ...
               if ((audioManager != null) && (audioEngine != null) &&
                  (audioManager.soundBank != null) && (audioManager.waveBank != null))
               {
                    audioManager.soundBank.PlayCue(cueName);
               }
          ...
          {
               // Start the new music cue.
               if ((audioManager != null) && (audioEngine != null) && //(audioManager.audioEngine != null) &&
                   (audioManager.soundBank != null) && (audioManager.waveBank != null))
               {
