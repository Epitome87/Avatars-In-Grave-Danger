...
namespace PixelEngine.Avatars
{
     ...
     public class Avatar : DrawableGameComponent, ILightable, ICollidable
     {
          ...
          protected override void LoadContent()
          {
               ...
               {
                   ShrunkenHeadTransforms.Add(Matrix.Identity);
               }
          ...
          {
               this.lightRotation = 195;//+= 0.01f;           // 195 is good
               ...
               */
               ...
               // LETS FUCKING TRY THIS MOTHER FUCKING THING HERE INSTERAD
               // New for object placement as of 2/27/2011
               // Update the current animation and world space bones
               if (avatarRenderer.State == AvatarRendererState.Ready)
               {
          ...
          public void UpdateWithoutAnimating()
          {
               // No reason to update animations if we can't even render!
               if (avatarRenderer == null)
               {
          ...
          public override void Draw(GameTime gameTime)
          {
               ...
               /*
               // THIS FIXES THE BONEWORLDSPACE STUFF BEING OUTDATED BY A FEW FRAMES!!!!!!!!
               if (avatarRenderer.State == AvatarRendererState.Ready)
               {
                    BonesToWorldSpace(avatarRenderer, this.AvatarAnimation, bonesWorldSpace);
               }
               */
               ...
               if (true)//isShadowEnabled)
               {
                    ...
                    this.avatarRenderer.AmbientLightColor = this.avatarRenderer.LightColor = -5000 * Vector3.One;
                    ...
                    // Change To: No Idea!              
                    //float sourceDepthBias = GraphicsDevice.RasterizerState.DepthBias;
                    //GraphicsDevice.RasterizerState.DepthBias = -0.0001f;

                    // Set the new light direction.
                    this.avatarRenderer.LightDirection = 
                         //Vector3.Normalize(Vector3.Right * 7.5f * (float)Math.Cos(lightRotation) +  Vector3.Forward * 15.0f * (float)Math.Sin(lightRotation) + Vector3.Up * 10.0f);
                         Vector3.Normalize(Vector3.Right * 7.5f * (float)Math.Cos(lightRotation) + Vector3.Backward * 15.0f * (float)Math.Sin(lightRotation) + Vector3.Up * 10.0f);
                    ...
                    this.avatarRenderer.World *= Matrix.CreateShadow(this.avatarRenderer.LightDirection, this.plane);
                    ...
                    // Change To: ???
                    //GraphicsDevice.RasterizerState.DepthBias = sourceDepthBias;
          ...
          List<Matrix> ShrunkenHeadTransforms = new List<Matrix>(AvatarRenderer.BoneCount);


          /// <summary>
          /// Overriden Component Draw. Calls AvatarRenderer.Draw if the AvatarRender is not null.
          /// </summary>
          public void DrawFirstPerson(GameTime gameTime)
          {
              // Can't render if Avatar Renderer is null!
              if (avatarRenderer == null)
                  return;
              ...
              if (this.AvatarAnimation != null)
              {
                  for (int i = 0; i < AvatarRenderer.BoneCount; i++)
                  {
                      ShrunkenHeadTransforms[i] = this.AvatarAnimation.CustomBoneTransforms[i];
                  }

                  // store neck matrix 
                  //Matrix OriginalNeckMat = ShrunkenHeadTransforms[(int)AvatarBone.Neck];

                  ShrunkenHeadTransforms[(int)AvatarBone.Neck] = Matrix.CreateScale(0.01f);

                  avatarRenderer.Draw(ShrunkenHeadTransforms, this.AvatarExpression);

                  // restore neck matrix 
                  //ShrunkenHeadTransforms[(int)AvatarBone.Neck] = OriginalNeckMat; 
              }
          ...
          public AvatarBaseAnimation PlayMultipleAnimation(bool loopAnimation, AvatarRenderer ar, List<AvatarBaseAnimation> animations, List<List<AvatarBone>> bones)
          {
               ...
               // NEW AS OF 12-11-2011: UPDATE FOR 1/10th of a second to fix that Christ-Crusifix-like pose glitch!!!!!!!!!!!!!!!!!!!!
               theAnimation.Update(TimeSpan.FromSeconds(0.1f));
          ...
          public AvatarBaseAnimation PlayMultipleAnimation(List<bool> loopThisAnimation, AvatarRenderer ar, List<AvatarBaseAnimation> animations, List<List<AvatarBone>> bones)
          {
               ...
               isAnimationLooping = false;//true;// loopAnimation;
               isAnimating = true;
          ...
          public void LoadRandomAvatar()
          {
               ...
               {
                    case 0:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale1AvatarDescription);
                         break;

                    case 1:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale2AvatarDescription);
                         break;

                    case 2:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale3AvatarDescription);
                         break;

                    case 3:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale4AvatarDescription);
                         break;

                    case 4:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale5AvatarDescription);
                         break;

                    case 5:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale6AvatarDescription);
                         break;

                    case 6:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale7AvatarDescription);
                         break;

                    case 7:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale8AvatarDescription);
                         break;

                    case 8:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale9AvatarDescription);
                         break;

                    case 9:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale10AvatarDescription);
                         break;

                    case 10:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale1AvatarDescription);
                         break;

                    case 11:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale2AvatarDescription);
                         break;

                    case 12:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale3AvatarDescription);
                         break;

                    case 13:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale4AvatarDescription);
                         break;                   
                    
                    case 14:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale5AvatarDescription);
                         break;

                    case 15:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale6AvatarDescription);
                         break;

                    case 16:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale7AvatarDescription);
                         break;

                    case 17:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale8AvatarDescription);
                         break;

                    case 18:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale9AvatarDescription);
                         break;

                    case 19:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale10AvatarDescription);
                         break;


                    case 20:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieDan);
                         break;

                    case 21:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieDeathhawk);
                         break;

                    case 22:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieJin);
                         break;

                    case 23:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieParagon);
                         break;

                    case 24:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieSylent);
                         break;
          ...
          public void LoadAvatar(CustomAvatarType avatarType)
          {
               ...
               switch (avatarType)
               {
                    case CustomAvatarType.Merchant:
                         avatarDescription = new AvatarDescription(AvatarDatabase.MerchantAvatarDescription);
                         break;



                    case CustomAvatarType.Zombie_Dan:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieDan);
                         break;                    
                    
                    case CustomAvatarType.Zombie_Deathhawk:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieDeathhawk);
                         break;

                    case CustomAvatarType.Zombie_Jin:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieJin);
                         break;

                    case CustomAvatarType.Zombie_Paragon:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieParagon);
                         break;

                    case CustomAvatarType.Zombie_Sylent:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieSylent);
                         break;



                    case CustomAvatarType.Zombie_Male_1:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale1AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_2:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale2AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_3:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale3AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_4:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale4AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_5:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale5AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_6:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale6AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_7:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale7AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_8:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale8AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_9:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale9AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Male_10:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieMale10AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_1:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale1AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_2:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale2AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_3:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale3AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_4:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale4AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_5:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale5AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_6:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale6AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_7:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale7AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_8:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale8AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_9:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale9AvatarDescription);
                         break;

                    case CustomAvatarType.Zombie_Female_10:
                         avatarDescription = new AvatarDescription(AvatarDatabase.ZombieFemale10AvatarDescription);
                         break;
                    ...
                    case CustomAvatarType.Matt_Zombiefied:
                         avatarDescription = new AvatarDescription(AvatarDatabase.MattZombieAvatarDescription);
                         break;
          ...
          void GetFriends(SignedInGamer gamer)
          {
               foreach (var friend in gamer.GetFriends())
               {
                    friend.BeginGetProfile(FriendsCallback, friend);
               }
          }

          static void FriendsCallback(IAsyncResult result)
          {
               GamerProfile friend = (result.AsyncState as Gamer).EndGetProfile(result);
          }

          void GetFriendList(SignedInGamer gamer)
          {
               FriendCollection friendList = gamer.GetFriends();
          }

          AvatarDescription GetFriendAvatarDescription(string gamerTag)
          {
               //Gamer friendGamer = Gamer.GetFromGamertag(gamerTag);
               //AvatarDescription.BeginGetFromGamer(friendGamer, FriendAvatarCallback, null);


               IAsyncResult avatarResult;
               avatarResult = AvatarDescription.BeginGetFromGamer(Gamer.GetFromGamertag(gamerTag), null, null);
               avatarDescription = AvatarDescription.EndGetFromGamer(avatarResult);

               return avatarDescription;
          }

          static void FriendAvatarCallback(IAsyncResult result)
          {
               AvatarDescription friendAvatarDescription = AvatarDescription.EndGetFromGamer(result);
          }
     }
}
