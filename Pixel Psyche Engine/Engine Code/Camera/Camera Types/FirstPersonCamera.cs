...
namespace PixelEngine.CameraSystem
{
     ...
     public class FirstPersonCamera : Camera
     {
          ...
          // Set rates in world units per 1/60th second (the default fixed-_step interval).
          float rotationSpeed = 2f / 60f;
          float forwardSpeed = 5f / 60f;

          Vector3 avatarPosition = new Vector3(0f, 0f, -4f);
          Vector3 avatarHeadOffset = new Vector3(0f, 2f, 0.2f);//(0f, 2f, 0f); 
          float avatarYaw;
          float avatarPitch;
          ...
          public static Vector3 headOffset = new Vector3(0f, 1.6f, 0.3f);//(0, 1.6f, 0f); //new Vector3(0, 1, 0);// = Vector3.Transform(avatarHeadOffset, rotationMatrix);
          ...
          private void UpdateCameraFirstPerson()
          {
               ...
               // Calculate the position the camera is looking at.
               //LookAt = Position + transformedReference;                   // THIS LINE IS FUCKING SHIT THE FUCK UP. DON'T CHANGE LookAt WITHOUT US KNOWING!!!!
          }
