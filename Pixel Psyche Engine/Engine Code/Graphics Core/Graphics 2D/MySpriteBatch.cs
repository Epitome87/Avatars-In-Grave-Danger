...
namespace PixelEngine.Graphics
{
     ...
     public static class MySpriteBatch
     {
          ...
          // TeSTING PHASE
          public static void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, 
          ...
          public static void Begin(SpriteSortMode sortMode, BlendState blendState, Matrix transformMatrix)
          {
               spriteBatch.Begin(sortMode, blendState, null, null, null, null, transformMatrix);
          }
          ...
          #region Draw Methods That ARE NOT Resolution Independent -- SHOULDN'T USE?
          ...
          public static void Draw(Texture2D texture, Rectangle destinationRectangle, Rectangle? sourceRectangle, 
          ...
          #region Draw Methods That Are Resolution Independent
          ...
          public static void DrawCentered(Texture2D texture, Rectangle rectangle, Color color)
          {
               ...
               spriteBatch.Draw(texture, tempRectangle, color);
          }

          public static void DrawCentered(Texture2D texture, Rectangle rectangle, Color color, float layerDepth)
          {
               Rectangle tempRectangle = rectangle;
               ...
               spriteBatch.Draw(texture, tempRectangle, null, color, 0f, Vector2.Zero, SpriteEffects.None, layerDepth);
          }
          ...
          #region SpriteBatch.DrawString Wrapper Methods - Resolution Independent
          ...
          public static void DrawStringTest(SpriteFont font, string text, Vector2 position, Color color)
          {
               spriteBatch.DrawString(font, text, position, color, 0f, new Vector2(), 1.0f, SpriteEffects.None, 0f);
          }
          public static void DrawStringTest(SpriteFont font, string text, Vector2 position, Color color, float scale)
          {
               spriteBatch.DrawString(font, text, position, color, 0f, new Vector2(), scale, SpriteEffects.None, 0f);
          }
          public static void DrawStringTest(SpriteFont font, string text, Vector2 position, Color color, float rotation, Vector2 origin, float scale, SpriteEffects effects, float depth)
          {
