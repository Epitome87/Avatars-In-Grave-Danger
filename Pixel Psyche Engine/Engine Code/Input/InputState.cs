...
namespace PixelEngine.Screen
{
     ...
     public class InputState
     {
          ...
          /// <summary>
          /// The current keyboard state for all input devices.
          /// </summary>
          public readonly KeyboardState[] CurrentKeyboardStates;

          /// <summary>
          /// The current GamePad state for all input devices.
          /// </summary>
          public readonly GamePadState[] CurrentGamePadStates;

          /// <summary>
          /// The previous keyboard state for all input devices.
          /// </summary>
          public readonly KeyboardState[] LastKeyboardStates;

          /// <summary>
          /// The previous GamePad state for all input devices.
          /// </summary>
          public readonly GamePadState[] LastGamePadStates;

          /// <summary>
          /// Whether or not the GamePad was connected for all input devices.
          /// </summary>
          public readonly bool[] GamePadWasConnected;

          /// <summary>
          /// Whether or not the GamePad was disconnected for all input devices.
          /// </summary>
          ...
          /// <summary>
          /// The GamePad vibration setting for all input devices.
          /// </summary>
          public static float[] GamePadVibration;

          /// <summary>
          /// Whether or not the GamePad is vibrating for all input devices.
          /// </summary>
          public static bool[] GamePadIsVibrating;

          public static float[] GamePadElapsedVibrationTime;
          public static float[] GamePadVibrationTime;
          ...
          public InputState()
          {
               ...
               GamePadVibration = new float[MaxInputs];
               GamePadIsVibrating = new bool[MaxInputs];

               GamePadElapsedVibrationTime = new float[MaxInputs];
               GamePadVibrationTime = new float[MaxInputs];
          }
          ...
          public void Update(GameTime gameTime)
          {
               for (int i = 0; i < MaxInputs; i++)
               {
                    ...
                    UpdateVibration((PlayerIndex)i, gameTime);
               }
          }
          ...
          public static void UpdateVibration(PlayerIndex playerIndex, GameTime gameTime)
          {
               int gamePadIndex = (int)playerIndex;

               if (GamePadIsVibrating[gamePadIndex])
               {
                    GamePadElapsedVibrationTime[gamePadIndex] += (float)gameTime.ElapsedGameTime.TotalSeconds;

                    if (GamePadElapsedVibrationTime[gamePadIndex] >= GamePadVibrationTime[gamePadIndex])
                    {
                         GamePadIsVibrating[gamePadIndex] = false;
          ...
          public static void SetVibration(PlayerIndex? playerIndex, float left, float right, float timeToVibrate)
          {
               ...
               int gamePadIndex = (int)playerIndex.Value;

               GamePadIsVibrating[gamePadIndex] = true;
               GamePadElapsedVibrationTime[gamePadIndex] = 0.0f;
               GamePadVibrationTime[gamePadIndex] = timeToVibrate;

               GamePad.SetVibration(playerIndex.Value, left, right);
          }
