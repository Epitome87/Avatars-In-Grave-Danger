...
namespace PixelEngine.Menu
{
     ...
     public class MenuEntry
     {
          ...
          public bool IsDrawFlexible = false;
          ...
          TextObject menuEntryTextObject;
               ...
               bool isSelected, GameTime gameTime)
          {
               ...
               menuEntryRectangle =
                    new Rectangle((int)position.X, (int)position.Y,
                         (int)(menuEntryBorderSize.X * menuEntryBorderScale.X), (int)(EngineCore.ResolutionScale * this.GetTrueHeight() * fontScale * menuEntryBorderScale.Y + 10));// + 20);
               */
               ...
               Vector2 slidingPosition = descriptionPosition;
               ...
               if (screen.ScreenState == ScreenState.TransitionOff && this == screen.SelectedMenuEntryTESTING)
               {
                    // Render the Description Border, if it's Enabled.
                    if (ShowDescriptionBorder)
                    {
                         Rectangle sighRect = new Rectangle((int)slidingPosition.X, (int)slidingPosition.Y, 800, 100);
                         MySpriteBatch.DrawCentered(blankTexture.Texture2D, sighRect, Color.Black * (150f / 255f) * (screen.TransitionAlpha / 255f));
                    }
               ...
               if (isSelected)
               {
                    ...
                    if (ShowDescriptionBorder)
                    {
                         if (IsCustomDescriptionRectangle)
                         {
                              MySpriteBatch.DrawCentered(blankTexture.Texture2D, CustomDescriptionRectangle, Color.Black * (150f / 255f) * (screen.TransitionAlpha / 255f));
                         }
                         ...
                         else
                         {
                              ...
                              //GraphicsHelper.DrawBorderCenteredFromRectangle(blankTexture.Texture2D, sighRect, 2, this.DescriptionColor);
                              MySpriteBatch.DrawCentered(blankTexture.Texture2D, sighRect, Color.Black * (150f / 255f) * (screen.TransitionAlpha / 255f));
                         }
                    }
                    ...
                    if (ShowBorder)
                    {
                         ...
                         MySpriteBatch.Draw(blankTexture.Texture2D, new Rectangle(0, (int)position.Y - (int)(EngineCore.ResolutionScale * fontScale * font.LineSpacing / 2),
                             EngineCore.GraphicsDevice.Viewport.Width, (int)(EngineCore.ResolutionScale * this.GetTrueHeight() * fontScale)),
                             BorderColor * (screen.TransitionAlpha / 255f));
                         */

                         MySpriteBatch.DrawCentered(blankTexture.Texture2D, new Rectangle((int)EngineCore.ScreenCenter.X, (int)position.Y,
                              EngineCore.GraphicsDevice.Viewport.Width, (int)(EngineCore.ResolutionScale * this.GetTrueHeight() * fontScale)),
                              BorderColor * (screen.TransitionAlpha / 255f));
                    }
                    ...
                    {
                         /*
                         MySpriteBatch.DrawCentered(GradientBorderTexture.Texture2D, 
                              menuEntryRectangle, selectedBorderColor * (screen.TransitionAlpha / 255f));
                         
                         MySpriteBatch.DrawCentered(GradientBorderTexture_TheBorder.Texture2D, 
                              menuEntryRectangle, Color.Black * (screen.TransitionAlpha / 255f));
                         */
                         MySpriteBatch.Draw(GradientBorderTexture.Texture2D,
                              menuEntryRectangle, selectedBorderColor * (screen.TransitionAlpha / 255f));

                         MySpriteBatch.Draw(GradientBorderTexture_TheBorder.Texture2D,
                              menuEntryRectangle, Color.Black * (screen.TransitionAlpha / 255f));
                    }
               ...
               else
               {
                    if (showGradientBorder)
                    {
                         /*
                         MySpriteBatch.DrawCentered(GradientBorderTexture.Texture2D,
                              menuEntryRectangle, unselectedBorderColor * (screen.TransitionAlpha / 255f));
               ...
               if (IsCenter)
               {
                    ...
                    menuEntryTextObject.DrawOld(gameTime);
               }
          ...
          public bool IsEntryTextVisible = true;

          public bool IsCustomDescriptionRectangle = false;
          public Rectangle CustomDescriptionRectangle = new Rectangle();

          public virtual void DrawDescriptionBorder(GameTime gameTime)
          {
