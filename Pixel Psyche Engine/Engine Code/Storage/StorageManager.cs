...
namespace PixelEngine.Storage
{
     ...
     public static class StorageManager
     {
          ...
          /// <summary>
          /// Whether or not a request to save the game has been requested.
          /// </summary>
          private static bool gameSaveRequested = false;

          /// <summary>
          /// The Storage Device used for saving.
          /// </summary>
          private static StorageDevice device;

          /// <summary>
          /// Our structure we store the Game's data to be saved in.
          /// </summary>
          ...
          /// </summary>
          private static string saveName = "Avatars In Grave Danger - Save";

          /// <summary>
          /// Whether or not the ability to Save is Enabled.
          /// </summary>
          ...
          public static void DoSaveGame(StorageDevice device, Object saveObject)
          {
               ...
               ScreenManager.AddPopupScreen(new PixelEngine.SavePopUpScreen("! Saving"), EngineCore.ControllingPlayer.Value);
