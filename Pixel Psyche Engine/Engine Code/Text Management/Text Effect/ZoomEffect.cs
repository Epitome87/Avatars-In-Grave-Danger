...
namespace PixelEngine.Text
{
     ...
     public class ZoomInEffect : TextEffect
     {
          ...
          public override void Draw(GameTime gameTime, TextObject textObj)
          {
               if (textObj.IsCenter)
               {
                    TextManager.DrawCentered(false, textObj.Font, textObj.Text, textObj.Position, textObj.Color,
                         textObj.Rotation, textObj.Origin, textObj.Scale, SpriteEffects.None, 0.0f);
               }

               else if (textObj.IsAutoCenter)
               {
                    TextManager.DrawCentered(true, textObj.Font, textObj.Text, textObj.Position, textObj.Color,
                         textObj.Rotation, textObj.Origin, textObj.Scale, SpriteEffects.None, 0.0f);
               }

               else
               {
                    TextManager.Draw(textObj.Font, textObj.Text, textObj.Position, textObj.Color,
