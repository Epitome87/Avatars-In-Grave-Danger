...
namespace PixelEngine.Text
{
     ...
     public class TextObject
     {
          ...
          /// </summary>
          public enum AlignmentTypeTheFuck
          {
          ...
          {
               get { return isAutoCenter; }
               set { isAutoCenter = value; }
          }
          ...
          /// </summary>
          public TextObject(string text, Vector2 position, FontType fontType,
          ...
          public void Draw(GameTime gameTime)
          {
               ...
               if (this.textEffects != null)
               {
                    ...
                    if (this.textEffects.Count < 1)
                    {
                         if (IsCenter)
                         {
                              TextManager.DrawCentered(false, this.Font, Text, Position, Color,
                                   Scale);//Rotation, Origin, Scale, SpriteEffects.None, 0.0f);
                         }
                    ...
                    // Added this || check on 8-13-2011) ******************* CLEAN THIS SHIT UPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP
                         // We have a valid list, but are the elements valid?
                    else if (this.textEffects.Count == 1)
                    {
                         if (this.textEffects[0] == null)
                         {
                              if (IsCenter)
                              {
                                   TextManager.DrawCentered(false, this.Font, Text, Position, Color, Scale);
                              }

                              else
                              {
                                   MySpriteBatch.DrawString(this.Font, text, position, color, rotation, origin, scale, SpriteEffects.None, 0);
                              }
                         }

                         else
                              this.textEffects[0].Draw(gameTime, this);
                    }
          ...
          /// If the Text Object has a valid Text Effect, that effect's Draw is called instead.
          /// </summary>
          public void DrawOld(GameTime gameTime)
          {
               // Return if the Text isn't even Visible.
               if (!this.isVisible)
                    return;
               ...
               if (this.textEffects != null)
               {
                    ...
                    if (this.textEffects.Count < 1)
                    {
                         if (IsCenter)
                         {
                              TextManager.DrawCenteredOld(false, this.Font, Text, Position, Color,
                                   Scale);//Rotation, Origin, Scale, SpriteEffects.None, 0.0f);
                         }
                    ...
                    else if (this.textEffects.Count == 1)
                    {
                         if (this.textEffects[0] == null)
                         {
                              if (IsCenter)
                              {
                                   TextManager.DrawCenteredOld(false, this.Font, Text, Position, Color, Scale);
                              }
          ...
          /// If the Text Object has a valid Text Effect, that effect's Draw is called instead.
          /// </summary>
          public void DrawColored(GameTime gameTime, AlignmentType alignmentType)
          {
               // Return if the Text isn't even Visible.
               if (!this.isVisible)
                    return;
               ...
               if (this.textEffects != null)
               {
                    ...
                    if (this.textEffects.Count < 1)
                    {
                         if (IsCenter)
                         {
                              ...
                              TextManager.DrawColorFormattedText(alignmentType, this.Font, Position, Text, scale, true);
                         }
